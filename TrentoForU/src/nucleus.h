...
class DeformedNucleusSpecialConfig : public MinDistNucleus {
 public:
  /// ``Nucleus::create()`` sets these parameters for a given species.
  /// \param A number of nucleons
  /// \param R Woods-Saxon radius
  ...
  /// \param beta4 Woods-Saxon deformation parameter
  /// \param dmin minimum nucleon-nucleon distance (optional, default zero)
  /// \param tilt_angle this is tilt angle
  /// \param spin_angle this is spin angle
  /// angle para
  double tilt_angle_min_, tilt_angle_max_;
  double spin_angle_min_, spin_angle_max_;
  double tilt_angle_, spin_angle_;
  DeformedNucleusSpecialConfig(std::size_t A, double R, double a,
                            double beta2, double beta4, 
                            double tilt_angle_min, double tilt_angle_max ,
                            double spin_angle_min, double spin_angle_max,
                            double dmin = 0);
