...
class Collider {
 ...
 private:
  ...
  std::tuple<double, int, double, double, double, double> sample_collision(std::string name);

  ///liuQi add new variables
  std::string projectileA_name_;
  std::string projectileB_name_;
